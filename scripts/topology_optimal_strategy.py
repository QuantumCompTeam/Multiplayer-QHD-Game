...
Run from repo root:
  conda run -n entangled-equilibria python scripts/topology_optimal_strategy.py            # ring, N=2..4
  conda run -n entangled-equilibria python scripts/topology_optimal_strategy.py ring 2 5   # topo, Nmin Nmax
"""
