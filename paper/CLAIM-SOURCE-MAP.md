...
| III-G (Restricted-menu equilibrium boundary) | $(Q_N,\ldots,Q_N)$ is a restricted-menu Nash equilibrium at $N=2,3$ and not at $N=4,5$ under the GHZ entangler, $V{=}4,\ C{=}3$ | Computational result today; Proposition proposed but contingent on the Task 13 derivation | Reused, not duplicated — see `tests/test_ne_guard.py::test_registered_values_reproduce`, `tests/test_ne_guard.py::test_candidate_identities`, `tests/test_ne_guard.py::test_boundary_inequality_agreement`, `tests/test_ne_guard.py::test_g9_hawk_breaks_q_at_n4_n5` |
