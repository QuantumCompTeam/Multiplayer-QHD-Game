...
\todo{Aasa: gamma-sweep thresholds (where the advantage crosses zero as
$\gamma$ is reduced from $\pi/2$); star hub/spoke asymmetry figure
(\texttt{per\_player\_advantage\_star.png}).}
