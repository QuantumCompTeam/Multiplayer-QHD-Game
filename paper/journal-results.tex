\subsubsection{Alternative Phase and Compact Evaluation}\label{sec:phase-results}
...
players at each node in linear work, giving quadratic contraction work once
the quadrature nodes are available. Nodes are cached; the timing experiment
warms that cache before measurement and does not time node generation.
...
\subsubsection{Sensitivity to Partial Conflict Costs}\label{sec:payoff-sensitivity}
