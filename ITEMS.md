...
| 16 | Results-save hardening + environment provenance | open — land before run 3 submits | G15, G16 | env-block template: results/hardware-scaling/preregistration.json |
