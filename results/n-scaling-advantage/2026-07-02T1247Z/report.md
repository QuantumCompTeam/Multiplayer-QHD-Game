...
| 4 | w | 1000 | 550 | pi/2 | 0 | 137.164910 | 181.250000 | -44.085090 † | yes | yes | ok |
...
**Cells with advantage <= 0 (RQ1 finding — investigate, do not paper over):**
  ...
  - N=4, w, gamma=pi/2: advantage = -44.085090
...
- (Q,Q,Q,Q) mean per-player payoff: **137.164910**
- Classical NE mean payoff: **181.250000**
- Advantage (QNE − CNE, mean): **-44.085090**
- (Q,Q,Q,Q) is pure Nash: **True**
- Player-symmetric: **True**

**Topology-optimized quantum strategy (nash mode):**

- Q := U(θ=2.775082, α=0.599788, β=0.582508)  (vs GHZ-fixed U(0, π/4, π/4))
- Symmetric payoff/player: **137.164910**
- Nash gap (max unilateral gain): **8.99e-01** → is Nash: **False**
- Optimizer converged: **False**
...
| deviator | alt | dev payoff | Q payoff | Q dominates |
|---|---|---|---|---|
| player 0 | D | 21.858037 | 137.164910 | yes |
| player 0 | H | 134.322498 | 137.164910 | yes |
| player 1 | D | 21.858037 | 137.164910 | yes |
| player 1 | H | 134.322498 | 137.164910 | yes |
| player 2 | D | 21.858037 | 137.164910 | yes |
| player 2 | H | 134.322498 | 137.164910 | yes |
| player 3 | D | 21.858037 | 137.164910 | yes |
| player 3 | H | 134.322498 | 137.164910 | yes |
