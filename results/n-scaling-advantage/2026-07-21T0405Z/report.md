...
| 2 | w | 4 | 3 | pi/2 | 0 | 1.995616 | 1.250000 | 0.745616 † | **NO** | yes | ok |
...
| 3 | w | 4 | 3 | pi/2 | 0 | 0.458447 | 0.833333 | -0.374886 † | yes | yes | ok |
| 4 | ghz | 4 | 3 | pi/2 | 0 | 0.250000 | 0.250000 | 0.000000 † | **NO** | yes | ok |
| 4 | ring | 4 | 3 | pi/2 | 0 | 0.250000 | 0.250000 | 0.000000 † | **NO** | yes | ok |
| 4 | star | 4 | 3 | pi/2 | 0 | 0.812500 | 0.250000 | 0.562500 † | **NO** | no | ok |
| 4 | fully-connected | 4 | 3 | pi/2 | 0 | 0.250000 | 0.250000 | 0.000000 † | **NO** | yes | ok |
| 4 | w | 4 | 3 | pi/2 | 0 | 0.509053 | 0.625000 | -0.115947 † | yes | yes | ok |
...
| 5 | fully-connected | 4 | 3 | pi/2 | 0 | 0.200000 | 0.200000 | 0.000000 † | **NO** | yes | ok |
| 5 | w | 4 | 3 | pi/2 | 0 | 0.410175 | 0.500000 | -0.089825 † | yes | yes | ok |
| 6 | ghz | 4 | 3 | pi/2 | 0 | 0.166667 | 0.166667 | 0.000000 † | **NO** | yes | ok |
| 6 | ring | 4 | 3 | pi/2 | 0 | 0.166667 | 0.166667 | 0.000000 † | **NO** | yes | ok |
| 6 | star | 4 | 3 | pi/2 | 0 | 0.166667 | 0.166667 | 0.000000 † | **NO** | yes | ok |
...
**Cells with advantage <= 0 (RQ1 finding — investigate, do not paper over):**
  - N=3, w, gamma=pi/2: advantage = -0.374886
  - N=4, w, gamma=pi/2: advantage = -0.115947
  - N=5, w, gamma=pi/2: advantage = -0.089825
...
- (Q,Q) mean per-player payoff: **1.995616**
- Classical NE mean payoff: **1.250000**
- Advantage (Q-profile − classical NE, mean): **0.745616**
- (Q,Q) is pure Nash: **False**
- Player-symmetric: **True**

**Topology-optimized quantum strategy (nash mode):**

- Q := U(θ=6.178727, α=1.511683, β=-1.600532)  (vs GHZ-fixed U(0, π/2, π/2))
- Symmetric payoff/player: **1.995616**
- Nash gap (max unilateral gain): **1.30e+00** → is Nash: **False**
- Optimizer converged: **False**
...
| deviator | alt | dev payoff | Q payoff | Q dominates |
|---|---|---|---|---|
| player 0 | D | 0.969573 | 1.995616 | yes |
| player 0 | H | 2.486981 | 1.995616 | **NO — NASH VIOLATED** |
| player 1 | D | 0.969573 | 1.995616 | yes |
| player 1 | H | 2.486981 | 1.995616 | **NO — NASH VIOLATED** |
...
- (Q,Q,Q) mean per-player payoff: **0.458447**
- Classical NE mean payoff: **0.833333**
- Advantage (Q-profile − classical NE, mean): **-0.374886**
- (Q,Q,Q) is pure Nash: **True**
- Player-symmetric: **True**

**Topology-optimized quantum strategy (nash mode):**

- Q := U(θ=3.679920, α=-7.216894, β=-3.989801)  (vs GHZ-fixed U(0, π/3, π/3))
- Symmetric payoff/player: **0.458447**
- Nash gap (max unilateral gain): **1.16e-01** → is Nash: **False**
- Optimizer converged: **False**
...
| deviator | alt | dev payoff | Q payoff | Q dominates |
|---|---|---|---|---|
| player 0 | D | 0.225765 | 0.458447 | yes |
| player 0 | H | 0.418979 | 0.458447 | yes |
| player 1 | D | 0.225765 | 0.458447 | yes |
| player 1 | H | 0.418979 | 0.458447 | yes |
| player 2 | D | 0.225765 | 0.458447 | yes |
| player 2 | H | 0.418979 | 0.458447 | yes |
...
- Q := U(θ=3.141593, α=-0.297478, β=0.785398)  (vs GHZ-fixed U(0, π/4, π/4))
- Symmetric payoff/player: **0.250000**
- Nash gap (max unilateral gain): **3.75e+00** → is Nash: **False**
- Optimizer converged: **False**
...
| deviator | alt | dev payoff | Q payoff | Q dominates |
|---|---|---|---|---|
| player 0 | D | 1.999999 | 0.250000 | **NO — NASH VIOLATED** |
| player 0 | H | 0.625000 | 0.250000 | **NO — NASH VIOLATED** |
| player 1 | D | 1.999999 | 0.250000 | **NO — NASH VIOLATED** |
| player 1 | H | 0.625000 | 0.250000 | **NO — NASH VIOLATED** |
| player 2 | D | 1.999999 | 0.250000 | **NO — NASH VIOLATED** |
| player 2 | H | 0.625000 | 0.250000 | **NO — NASH VIOLATED** |
| player 3 | D | 1.999999 | 0.250000 | **NO — NASH VIOLATED** |
| player 3 | H | 0.625000 | 0.250000 | **NO — NASH VIOLATED** |
...
- (Q,Q,Q,Q) mean per-player payoff: **0.812500**
- Classical NE mean payoff: **0.250000**
- Advantage (Q-profile − classical NE, mean): **0.562500**
- (Q,Q,Q,Q) is pure Nash: **False**
- Player-symmetric: **False**

**Topology-optimized quantum strategy (nash mode):** _(symmetric-strategy caveat: topology is not vertex-transitive, so this is a constrained sub-optimum)_

- Q := U(θ=3.141593, α=-0.290956, β=0.785398)  (vs GHZ-fixed U(0, π/4, π/4))
- Symmetric payoff/player: **0.812500**
- Nash gap (max unilateral gain): **7.71e-01** → is Nash: **False**
- Optimizer converged: **False**

**Per-player breakdown (asymmetric topology):**

- Q payoff vector: [1.5625, 0.5625, 0.5625, 0.5625]
- Classical NE payoff vector: [0.2500, 0.2500, 0.2500, 0.2500]
- Advantage vector: [1.3125, 0.3125, 0.3125, 0.3125]
...
| deviator | alt | dev payoff | Q payoff | Q dominates |
|---|---|---|---|---|
| player 0 | D | 1.000000 | 1.562500 | yes |
| player 0 | H | 0.906250 | 1.562500 | yes |
| player 1 | D | 1.000000 | 0.562500 | **NO — NASH VIOLATED** |
| player 1 | H | 0.906250 | 0.562500 | **NO — NASH VIOLATED** |
| player 2 | D | 1.000000 | 0.562500 | **NO — NASH VIOLATED** |
| player 2 | H | 0.906250 | 0.562500 | **NO — NASH VIOLATED** |
| player 3 | D | 1.000000 | 0.562500 | **NO — NASH VIOLATED** |
| player 3 | H | 0.906250 | 0.562500 | **NO — NASH VIOLATED** |
...
- Q := U(θ=3.141593, α=-1.196848, β=-2.356195)  (vs GHZ-fixed U(0, π/4, π/4))
- Symmetric payoff/player: **0.250000**
- Nash gap (max unilateral gain): **3.75e+00** → is Nash: **False**
- Optimizer converged: **False**
...
| deviator | alt | dev payoff | Q payoff | Q dominates |
|---|---|---|---|---|
| player 0 | D | 2.000002 | 0.250000 | **NO — NASH VIOLATED** |
| player 0 | H | 0.625000 | 0.250000 | **NO — NASH VIOLATED** |
| player 1 | D | 2.000002 | 0.250000 | **NO — NASH VIOLATED** |
| player 1 | H | 0.625000 | 0.250000 | **NO — NASH VIOLATED** |
| player 2 | D | 2.000002 | 0.250000 | **NO — NASH VIOLATED** |
| player 2 | H | 0.625000 | 0.250000 | **NO — NASH VIOLATED** |
| player 3 | D | 2.000002 | 0.250000 | **NO — NASH VIOLATED** |
| player 3 | H | 0.625000 | 0.250000 | **NO — NASH VIOLATED** |

### N=4 · w · gamma=pi/2 (V=4, C=3)

- (Q,Q,Q,Q) mean per-player payoff: **0.509053**
- Classical NE mean payoff: **0.625000**
- Advantage (Q-profile − classical NE, mean): **-0.115947**
- (Q,Q,Q,Q) is pure Nash: **True**
- Player-symmetric: **True**

**Topology-optimized quantum strategy (nash mode):**

- Q := U(θ=2.975091, α=-1.341629, β=-1.034794)  (vs GHZ-fixed U(0, π/4, π/4))
- Symmetric payoff/player: **0.509053**
- Nash gap (max unilateral gain): **1.24e-03** → is Nash: **False**
- Optimizer converged: **False**
...
| deviator | alt | dev payoff | Q payoff | Q dominates |
|---|---|---|---|---|
| player 0 | D | 0.040532 | 0.509053 | yes |
| player 0 | H | 0.507056 | 0.509053 | yes |
| player 1 | D | 0.040532 | 0.509053 | yes |
| player 1 | H | 0.507056 | 0.509053 | yes |
| player 2 | D | 0.040532 | 0.509053 | yes |
| player 2 | H | 0.507056 | 0.509053 | yes |
| player 3 | D | 0.040532 | 0.509053 | yes |
| player 3 | H | 0.507056 | 0.509053 | yes |
...
- Q := U(θ=3.141593, α=-0.700676, β=1.570796)  (vs GHZ-fixed U(0, π/5, π/5))
- Symmetric payoff/player: **0.200000**
- Nash gap (max unilateral gain): **3.80e+00** → is Nash: **False**
- Optimizer converged: **True**
...
| player 0 | D | 0.800000 | 0.200000 | **NO — NASH VIOLATED** |
| player 0 | H | 4.000000 | 0.200000 | **NO — NASH VIOLATED** |
| player 1 | D | 0.800000 | 0.200000 | **NO — NASH VIOLATED** |
| player 1 | H | 4.000000 | 0.200000 | **NO — NASH VIOLATED** |
| player 2 | D | 0.800000 | 0.200000 | **NO — NASH VIOLATED** |
| player 2 | H | 4.000000 | 0.200000 | **NO — NASH VIOLATED** |
| player 3 | D | 0.800000 | 0.200000 | **NO — NASH VIOLATED** |
| player 3 | H | 4.000000 | 0.200000 | **NO — NASH VIOLATED** |
| player 4 | D | 0.800000 | 0.200000 | **NO — NASH VIOLATED** |
| player 4 | H | 4.000000 | 0.200000 | **NO — NASH VIOLATED** |

### N=5 · w · gamma=pi/2 (V=4, C=3)

- (Q,Q,Q,Q,Q) mean per-player payoff: **0.410175**
- Classical NE mean payoff: **0.500000**
- Advantage (Q-profile − classical NE, mean): **-0.089825**
- (Q,Q,Q,Q,Q) is pure Nash: **True**
- Player-symmetric: **True**

**Topology-optimized quantum strategy (nash mode):**

- Q := U(θ=2.999216, α=-1.410459, β=-1.680243)  (vs GHZ-fixed U(0, π/5, π/5))
- Symmetric payoff/player: **0.410175**
- Nash gap (max unilateral gain): **4.60e-04** → is Nash: **False**
- Optimizer converged: **False**
...
| deviator | alt | dev payoff | Q payoff | Q dominates |
|---|---|---|---|---|
| player 0 | D | 0.021662 | 0.410175 | yes |
| player 0 | H | 0.408717 | 0.410175 | yes |
| player 1 | D | 0.021662 | 0.410175 | yes |
| player 1 | H | 0.408717 | 0.410175 | yes |
| player 2 | D | 0.021662 | 0.410175 | yes |
| player 2 | H | 0.408717 | 0.410175 | yes |
| player 3 | D | 0.021662 | 0.410175 | yes |
| player 3 | H | 0.408717 | 0.410175 | yes |
| player 4 | D | 0.021662 | 0.410175 | yes |
| player 4 | H | 0.408717 | 0.410175 | yes |
...
- Q := U(θ=3.141593, α=-1.688979, β=-1.570797)  (vs GHZ-fixed U(0, π/6, π/6))
...
| deviator | alt | dev payoff | Q payoff | Q dominates |
|---|---|---|---|---|
| player 0 | D | 4.000000 | 0.166667 | **NO — NASH VIOLATED** |
| player 0 | H | 0.666667 | 0.166667 | **NO — NASH VIOLATED** |
| player 1 | D | 4.000000 | 0.166667 | **NO — NASH VIOLATED** |
| player 1 | H | 0.666667 | 0.166667 | **NO — NASH VIOLATED** |
| player 2 | D | 4.000000 | 0.166667 | **NO — NASH VIOLATED** |
| player 2 | H | 0.666667 | 0.166667 | **NO — NASH VIOLATED** |
| player 3 | D | 4.000000 | 0.166667 | **NO — NASH VIOLATED** |
| player 3 | H | 0.666667 | 0.166667 | **NO — NASH VIOLATED** |
| player 4 | D | 4.000000 | 0.166667 | **NO — NASH VIOLATED** |
| player 4 | H | 0.666667 | 0.166667 | **NO — NASH VIOLATED** |
| player 5 | D | 4.000000 | 0.166667 | **NO — NASH VIOLATED** |
| player 5 | H | 0.666667 | 0.166667 | **NO — NASH VIOLATED** |
...
- Q := U(θ=3.141593, α=0.183353, β=-1.570796)  (vs GHZ-fixed U(0, π/6, π/6))
- Symmetric payoff/player: **0.166667**
...
| player 0 | H | 1.000000 | 0.166667 | **NO — NASH VIOLATED** |
| player 1 | D | 0.000000 | 0.166667 | yes |
| player 1 | H | 1.000000 | 0.166667 | **NO — NASH VIOLATED** |
| player 2 | D | 0.000000 | 0.166667 | yes |
| player 2 | H | 1.000000 | 0.166667 | **NO — NASH VIOLATED** |
| player 3 | D | 0.000000 | 0.166667 | yes |
| player 3 | H | 1.000000 | 0.166667 | **NO — NASH VIOLATED** |
| player 4 | D | 0.000000 | 0.166667 | yes |
| player 4 | H | 1.000000 | 0.166667 | **NO — NASH VIOLATED** |
| player 5 | D | 0.000000 | 0.166667 | yes |
| player 5 | H | 1.000000 | 0.166667 | **NO — NASH VIOLATED** |
...
| player 0 | D | 4.000000 | 0.166667 | **NO — NASH VIOLATED** |
| player 0 | H | 0.666667 | 0.166667 | **NO — NASH VIOLATED** |
| player 1 | D | 0.800000 | 0.166667 | **NO — NASH VIOLATED** |
| player 1 | H | 0.000000 | 0.166667 | yes |
| player 2 | D | 0.800000 | 0.166667 | **NO — NASH VIOLATED** |
| player 2 | H | 0.000000 | 0.166667 | yes |
| player 3 | D | 0.800000 | 0.166667 | **NO — NASH VIOLATED** |
| player 3 | H | 0.000000 | 0.166667 | yes |
| player 4 | D | 0.800000 | 0.166667 | **NO — NASH VIOLATED** |
| player 4 | H | 0.000000 | 0.166667 | yes |
| player 5 | D | 0.800000 | 0.166667 | **NO — NASH VIOLATED** |
| player 5 | H | 0.000000 | 0.166667 | yes |
